...
ruta_reporte = "C:\\Users\\dapache\\OneDrive - NUEVA EPS\\GO_PQR\\datamaker\\"
datos_cert_1427.to_csv(ruta_reporte + 'datos_cert_1427.txt', index=False)
reg_1427.to_csv(ruta_reporte+ 'reg_1427.txt', index=False)
